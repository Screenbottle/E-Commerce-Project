...
public static class ApiExtensions
{
    ...
    public static async Task<IResult> HttpPostAsync<TEntity, TPostDto>(DbService db, TPostDto dto) where TEntity : class, IEntity where TPostDto : class
    {
        try
        {
    ...
    public static async Task<IResult> HttpPutAsync<TEntity, TPutDto>(DbService db, TPutDto dto) where TEntity : class, IEntity where TPutDto : class
    {
        try
        {
    ...
    public static async Task<IResult> HttpDeleteAsync<TEntity>(DbService db, int id) where TEntity : class, IEntity
    {
        try
        {
